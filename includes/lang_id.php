...
$translations = [
    // General
    'Reimbursement System' => 'Sistem Reimbursement',
    'Dashboard' => 'Dasbor',
    'New Request' => 'Permintaan Baru',
    'Manage Requests' => 'Kelola Permintaan',
    ...
    'Enter brief description of your reimbursement request' => 'Masukkan deskripsi singkat permintaan reimbursement Anda',
    'Enter item name' => 'Masukkan nama item',
    'Select receipt file...' => 'Pilih file bukti...',
    'Category' => 'Kategori',
    'Select Category' => 'Pilih Kategori',
    'Amount (Rp)' => 'Jumlah (Rp)',
    'Date of Expense' => 'Tanggal Pengeluaran',
    'Receipt (optional)' => 'Bukti (opsional)',
    'Upload receipt image or PDF (JPG, PNG, PDF files allowed)' => 'Unggah bukti dalam bentuk gambar atau PDF (format yang diperbolehkan: JPG, PNG, PDF)',
    ...
    'Request denied successfully!' => 'Permintaan berhasil ditolak!',
    'Request marked as paid!' => 'Permintaan ditandai sebagai dibayar!',
